...
def continuous_peaks_input_size():
    ...
    for n in range(10, 101, 10):
        ...
        print("input size ", n)
        fitness = mlr_h.ContinuousPeaks(t_pct=0.1)
        ...
        problem = mlr_h.DiscreteOpt(length=n, fitness_fn=fitness, maximize=True, max_val=2)
        init_state = np.random.randint(2, size=n)
        schedule = mlr_h.ExpDecay(init_temp=1)
        print("SA")
        st = time.time()
    ...
    plt.savefig('C_PeaksInputSizeFitness.png')
    plt.clf()
    ...
    plt.savefig('C_PeaksInputSizeComputation.png')
    plt.clf()
...
def continuous_peaks_iterations():
    ...
    problem = mlr_h.DiscreteOpt(length=100, fitness_fn=fitness, maximize=True, max_val=2)
    init_state = np.random.randint(2, size=100)
    best_state_rhc, best_fitness_rhc, fitness_curve_rhc = mlr_h.random_hill_climb(problem, restarts=10,
                                                                                   max_attempts=1000,
                                                                                   max_iters=10000,
                                                                                   init_state=init_state,
                                                                                   random_state=42,
    ...
    plt.savefig('C_PeaksIterations.png')
    plt.clf()
...
def continuous_peaks_sa():
    ...
    plt.ylabel('Fitness Value')
    plt.title('Continuous Peaks - SA - HyperParam Comparison')
    plt.savefig('C_Peaks_SA.png')
    plt.clf()
...
def continuous_peaks_rhc():
    ...
    plt.title('Continuous Peaks - RHC - HyperParam Comparison')
    plt.legend()
    plt.grid()
    plt.xlabel('Iterations#')
    plt.ylabel('Fitness Value')
    plt.savefig('C_PeaksRhcAnalysis.png')
    plt.clf()
...
def continuous_peaks_mimic():
    ...
    plt.title('Continuous Peaks - MIMIC - HyperParam Comparison')
    plt.legend()
    plt.grid()
    plt.xlabel('Iterations#')
    plt.ylabel('Fitness Value')
    plt.savefig('C_PeaksMimicAnalysis.png')
    plt.clf()
...
def continuous_peaks_ga():
    ...
    plt.title('Continuous Peaks - GA - HyperParam Comparison')
    plt.legend()
    plt.grid()
    plt.xlabel('Iterations#')
    plt.ylabel('Fitness Value')
    plt.savefig('C_PeaksGaAnalysis.png')
    plt.clf()


############################################ continuous Peaks main block #######################################
